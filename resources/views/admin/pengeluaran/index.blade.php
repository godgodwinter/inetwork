    ...
    <div class="card">
        <div class="row">
            <div class="col-xl-6 col-md-6">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form style="border: 4px solid #a1a1a1;margin-top: 15px;padding: 10px;"
                                        action="{{ route('importpengeluaran') }}" class="form-horizontal" method="post"
                ...
                <a href="{{ url('/')}}/admin/cetak/{{ $blnthn }}/pengeluaran-bulanini/" class="btn btn-sm  btn-primary" target="_blank"><i class="feather icon-moon"></i>PDF BULAN INI</a>
            </div>
    ...
    <div class="card table-card">
        ...
        <script>
            $(function(e){
                ...
                $.ajax({
                    url:"{{ route('pengeluaran.kategori.deleteSelected') }}",
                    type:"DELETE",
                    data:{
                        _token:$("input[name=_token]").val(),
                        ids:allids
