...
@php
    $idkategori=$data->jenispengeluaran_id;
    $kategori=$data->jenispengeluaran_nama;
@endphp
@endforeach

@php
    $d2s = DB::table('jenispengeluaran')->where('id',$data->jenispengeluaran_id)->get();
@endphp
@foreach ($d2s as $d2)
$idkategori=$d2->id;
$kategori=$d2->nama;
@endforeach
    ...
    <div class="card" id="add" >
        ...
        <div class="card-block">
            <div class="card-body">
                <form action="/admin/pengeluaran/{{$data->id}}" method="post">
                    @method('put')
                    @csrf
                    <div class="pl-lg-4">
                        <div class="row">
