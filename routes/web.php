...
Route::group(['middleware' => ['auth:sanctum', 'verified']], function() {
    ...
    Route::get('admin/tagihan/{blnthn}/{tagihan}/{orderby}/{ascdesc}/tagihanbln', 'App\Http\Controllers\AdminTagihanController@showtagihanbln');
    Route::get('admin/tagihan/{blnthn}/cari', 'App\Http\Controllers\AdminTagihanController@cari')->name('tagihan-cari');
    Route::get('admin/tagihan/{blnthn}/{tagihan}/{orderby}/{ascdesc}/{cari}/tagihan-cari', 'App\Http\Controllers\AdminTagihanController@showcari')->name('tagihan-cari');


    Route::get('admin/tagihan-lunas', 'App\Http\Controllers\AdminTagihanController@lunas');
    Route::get('admin/tagihan-belumlunas', 'App\Http\Controllers\AdminTagihanController@belumlunas');
